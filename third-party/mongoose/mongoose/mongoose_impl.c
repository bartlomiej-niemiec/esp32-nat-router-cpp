...
struct attribute s_login_attributes[] = {
  {"password", "string", NULL, offsetof(struct login, password), 32, false},
  {"username", "string", NULL, offsetof(struct login, username), 32, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_saveapsettings_attributes[] = {
  {"networkmask", "string", NULL, offsetof(struct saveapsettings, networkmask), 16, false},
  {"ipaddress", "string", NULL, offsetof(struct saveapsettings, ipaddress), 16, false},
  {"password", "string", NULL, offsetof(struct saveapsettings, password), 64, false},
  {"name", "string", NULL, offsetof(struct saveapsettings, name), 32, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_savestasettings_attributes[] = {
  {"Name", "string", NULL, offsetof(struct savestasettings, Name), 32, false},
  {"Password", "string", NULL, offsetof(struct savestasettings, Password), 64, false},
  {"SSIDNoId", "int", NULL, offsetof(struct savestasettings, SSIDNoId), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_stanetworks_attributes[] = {
  {"net8_auth", "string", NULL, offsetof(struct stanetworks, net8_auth), 32, false},
  {"net8_channel", "int", NULL, offsetof(struct stanetworks, net8_channel), 0, false},
  {"net8_rssi", "int", NULL, offsetof(struct stanetworks, net8_rssi), 0, false},
  {"net8_ssid", "string", NULL, offsetof(struct stanetworks, net8_ssid), 32, false},
  {"net7_auth", "string", NULL, offsetof(struct stanetworks, net7_auth), 32, false},
  {"net7_channel", "int", NULL, offsetof(struct stanetworks, net7_channel), 0, false},
  {"net7_rssi", "int", NULL, offsetof(struct stanetworks, net7_rssi), 0, false},
  {"net7_ssid", "string", NULL, offsetof(struct stanetworks, net7_ssid), 32, false},
  {"net6_auth", "string", NULL, offsetof(struct stanetworks, net6_auth), 32, false},
  {"net6_channel", "int", NULL, offsetof(struct stanetworks, net6_channel), 0, false},
  {"net6_rssi", "int", NULL, offsetof(struct stanetworks, net6_rssi), 0, false},
  {"net6_ssid", "string", NULL, offsetof(struct stanetworks, net6_ssid), 32, false},
  {"networkFound", "int", NULL, offsetof(struct stanetworks, networkFound), 0, false},
  {"net1_ssid", "string", NULL, offsetof(struct stanetworks, net1_ssid), 32, false},
  {"net1_rssi", "int", NULL, offsetof(struct stanetworks, net1_rssi), 0, false},
  {"net1_channel", "int", NULL, offsetof(struct stanetworks, net1_channel), 0, false},
  {"net1_auth", "string", NULL, offsetof(struct stanetworks, net1_auth), 32, false},
  {"net2_ssid", "string", NULL, offsetof(struct stanetworks, net2_ssid), 32, false},
  {"net2_rssi", "int", NULL, offsetof(struct stanetworks, net2_rssi), 0, false},
  {"net2_channel", "int", NULL, offsetof(struct stanetworks, net2_channel), 0, false},
  {"net2_auth", "string", NULL, offsetof(struct stanetworks, net2_auth), 32, false},
  {"net3_ssid", "string", NULL, offsetof(struct stanetworks, net3_ssid), 32, false},
  {"net3_rssi", "int", NULL, offsetof(struct stanetworks, net3_rssi), 0, false},
  {"net3_channel", "int", NULL, offsetof(struct stanetworks, net3_channel), 0, false},
  {"net3_auth", "string", NULL, offsetof(struct stanetworks, net3_auth), 32, false},
  {"net4_ssid", "string", NULL, offsetof(struct stanetworks, net4_ssid), 32, false},
  {"net4_rssi", "int", NULL, offsetof(struct stanetworks, net4_rssi), 0, false},
  {"net4_channel", "int", NULL, offsetof(struct stanetworks, net4_channel), 0, false},
  {"net4_auth", "string", NULL, offsetof(struct stanetworks, net4_auth), 32, false},
  {"net5_ssid", "string", NULL, offsetof(struct stanetworks, net5_ssid), 32, false},
  {"net5_rssi", "int", NULL, offsetof(struct stanetworks, net5_rssi), 0, false},
  {"net5_channel", "int", NULL, offsetof(struct stanetworks, net5_channel), 0, false},
  {"net5_auth", "string", NULL, offsetof(struct stanetworks, net5_auth), 32, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_info_attributes[] = {
  {"Clients", "int", NULL, offsetof(struct info, Clients), 0, false},
  {"StaIa", "bool", NULL, offsetof(struct info, StaIa), 0, false},
  {"StaConn", "bool", NULL, offsetof(struct info, StaConn), 0, false},
  {"State", "string", NULL, offsetof(struct info, State), 32, false},
  {"STA", "string", NULL, offsetof(struct info, STA), 32, false},
  {"AP", "string", NULL, offsetof(struct info, AP), 32, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_proto_stats_ip_attributes[] = {
  {"lenerr", "int", NULL, offsetof(struct proto_stats_ip, lenerr), 0, false},
  {"chkerr", "int", NULL, offsetof(struct proto_stats_ip, chkerr), 0, false},
  {"drop", "int", NULL, offsetof(struct proto_stats_ip, drop), 0, false},
  {"fw", "int", NULL, offsetof(struct proto_stats_ip, fw), 0, false},
  {"rx", "int", NULL, offsetof(struct proto_stats_ip, rx), 0, false},
  {"tx", "int", NULL, offsetof(struct proto_stats_ip, tx), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_proto_stats_tcp_attributes[] = {
  {"lenerr", "int", NULL, offsetof(struct proto_stats_tcp, lenerr), 0, false},
  {"chkerr", "int", NULL, offsetof(struct proto_stats_tcp, chkerr), 0, false},
  {"drop", "int", NULL, offsetof(struct proto_stats_tcp, drop), 0, false},
  {"fw", "int", NULL, offsetof(struct proto_stats_tcp, fw), 0, false},
  {"rx", "int", NULL, offsetof(struct proto_stats_tcp, rx), 0, false},
  {"tx", "int", NULL, offsetof(struct proto_stats_tcp, tx), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_proto_stats_udp_attributes[] = {
  {"lenerr", "int", NULL, offsetof(struct proto_stats_udp, lenerr), 0, false},
  {"chkerr", "int", NULL, offsetof(struct proto_stats_udp, chkerr), 0, false},
  {"drop", "int", NULL, offsetof(struct proto_stats_udp, drop), 0, false},
  {"fw", "int", NULL, offsetof(struct proto_stats_udp, fw), 0, false},
  {"rx", "int", NULL, offsetof(struct proto_stats_udp, rx), 0, false},
  {"tx", "int", NULL, offsetof(struct proto_stats_udp, tx), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_proto_stats_icmp_attributes[] = {
  {"chkerr", "int", NULL, offsetof(struct proto_stats_icmp, chkerr), 0, false},
  {"lenerr", "int", NULL, offsetof(struct proto_stats_icmp, lenerr), 0, false},
  {"drop", "int", NULL, offsetof(struct proto_stats_icmp, drop), 0, false},
  {"fw", "int", NULL, offsetof(struct proto_stats_icmp, fw), 0, false},
  {"rx", "int", NULL, offsetof(struct proto_stats_icmp, rx), 0, false},
  {"tx", "int", NULL, offsetof(struct proto_stats_icmp, tx), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_napt_stats_attributes[] = {
  {"forced_evictions_no", "int", NULL, offsetof(struct napt_stats, forced_evictions_no), 0, false},
  {"active_icmp_conn", "int", NULL, offsetof(struct napt_stats, active_icmp_conn), 0, false},
  {"active_udp_conn", "int", NULL, offsetof(struct napt_stats, active_udp_conn), 0, false},
  {"active_tcp_conn", "int", NULL, offsetof(struct napt_stats, active_tcp_conn), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};

struct apihandler_action s_apihandler_applynetworkconfig = {{"applynetworkconfig", "action", false, 7, 7, 0UL}, glue_check_applynetworkconfig, glue_start_applynetworkconfig};
...
struct apihandler_data s_apihandler_saveapsettings = {{"saveapsettings", "data", false, 7, 7, 0UL}, s_saveapsettings_attributes, sizeof(struct saveapsettings), (void (*)(void *)) glue_get_saveapsettings, (void (*)(void *)) glue_set_saveapsettings};
struct apihandler_data s_apihandler_savestasettings = {{"savestasettings", "data", false, 7, 7, 0UL}, s_savestasettings_attributes, sizeof(struct savestasettings), (void (*)(void *)) glue_get_savestasettings, (void (*)(void *)) glue_set_savestasettings};
struct apihandler_data s_apihandler_stanetworks = {{"stanetworks", "data", true, 1, 0, 0UL}, s_stanetworks_attributes, sizeof(struct stanetworks), (void (*)(void *)) glue_get_stanetworks, NULL};
struct apihandler_action s_apihandler_setsta = {{"setsta", "action", false, 7, 7, 0UL}, glue_check_setsta, glue_start_setsta};
struct apihandler_data s_apihandler_info = {{"info", "data", false, 1, 0, 0UL}, s_info_attributes, sizeof(struct info), (void (*)(void *)) glue_get_info, (void (*)(void *)) glue_set_info};
struct apihandler_action s_apihandler_scannetworks = {{"scannetworks", "action", false, 1, 1, 0UL}, glue_check_scannetworks, glue_start_scannetworks};
struct apihandler_action s_apihandler_save_event = {{"save_event", "action", false, 1, 1, 0UL}, glue_check_save_event, glue_start_save_event};
struct apihandler_data s_apihandler_proto_stats_ip = {{"proto_stats_ip", "data", false, 0, 0, 0UL}, s_proto_stats_ip_attributes, sizeof(struct proto_stats_ip), (void (*)(void *)) glue_get_proto_stats_ip, (void (*)(void *)) glue_set_proto_stats_ip};
struct apihandler_data s_apihandler_proto_stats_tcp = {{"proto_stats_tcp", "data", false, 0, 0, 0UL}, s_proto_stats_tcp_attributes, sizeof(struct proto_stats_tcp), (void (*)(void *)) glue_get_proto_stats_tcp, (void (*)(void *)) glue_set_proto_stats_tcp};
struct apihandler_data s_apihandler_proto_stats_udp = {{"proto_stats_udp", "data", false, 0, 0, 0UL}, s_proto_stats_udp_attributes, sizeof(struct proto_stats_udp), (void (*)(void *)) glue_get_proto_stats_udp, (void (*)(void *)) glue_set_proto_stats_udp};
struct apihandler_data s_apihandler_proto_stats_icmp = {{"proto_stats_icmp", "data", false, 0, 0, 0UL}, s_proto_stats_icmp_attributes, sizeof(struct proto_stats_icmp), (void (*)(void *)) glue_get_proto_stats_icmp, (void (*)(void *)) glue_set_proto_stats_icmp};
struct apihandler_data s_apihandler_napt_stats = {{"napt_stats", "data", false, 0, 0, 0UL}, s_napt_stats_attributes, sizeof(struct napt_stats), (void (*)(void *)) glue_get_napt_stats, (void (*)(void *)) glue_set_napt_stats};
...
static struct apihandler *s_apihandlers[] = {
  (struct apihandler *) &s_apihandler_applynetworkconfig,
  (struct apihandler *) &s_apihandler_login,
  (struct apihandler *) &s_apihandler_saveapsettings,
  (struct apihandler *) &s_apihandler_savestasettings,
  (struct apihandler *) &s_apihandler_stanetworks,
  (struct apihandler *) &s_apihandler_setsta,
  (struct apihandler *) &s_apihandler_info,
  (struct apihandler *) &s_apihandler_scannetworks,
  (struct apihandler *) &s_apihandler_save_event,
  (struct apihandler *) &s_apihandler_proto_stats_ip,
  (struct apihandler *) &s_apihandler_proto_stats_tcp,
  (struct apihandler *) &s_apihandler_proto_stats_udp,
  (struct apihandler *) &s_apihandler_proto_stats_icmp,
  (struct apihandler *) &s_apihandler_napt_stats,
     ...
     (ch != NULL &&
      (u->level < ch->read_level ||
       (hm->body.len > 0 && u->level < ch->write_level))))) {
          ...
          if (u == NULL) {
            mg_http_reply(c, 401,
                          "WWW-Authenticate: Basic realm=\"Mongoose\"\r\n"
