...
#include "wifi_nat_router_if/wifi_scanner_if.hpp"
    ...
    public WifiScannerIf
{
    ...
    private:
        ...
        WifiNatRouterConfig m_PendingConfig;
        ...
        std::vector<EventListener *> m_WifiNatRouterStateListeners;
        ...
        struct Snapshot{
            const WifiNatRouterState mgrState;
